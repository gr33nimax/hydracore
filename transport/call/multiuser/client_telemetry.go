...
func clientWorkerSnapshotMetrics() []telemetry.Metric {
	return []telemetry.Metric{
		...
		telemetry.WorkerPathDeliveryRateBPS,
		telemetry.WorkerPathWindowSegments,
		telemetry.WorkerPathInflightSegments,
		...
		telemetry.WorkerPathBackoffTotal,
		telemetry.WorkerPathFeedbackCapable,
		telemetry.WorkerPathFeedbackAgeMS,
		telemetry.WorkerPathFeedbackRecordsTotal,
		telemetry.WorkerPathFeedbackAckedPacketsTotal,
		telemetry.WorkerPathFeedbackLostPacketsTotal,
		telemetry.WorkerPathControlCopiesTotal,
