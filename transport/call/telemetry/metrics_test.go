...
func TestRequiredMetricContractMatchesHydraUltimate(t *testing.T) {
	...
	serverExpected := []string{
		...
		"kcp_wait_snd", "kcp_out_segments_total", "kcp_retrans_segments_total", "kcp_out_bytes_total", "kcp_retrans_bytes_total",
		"kcp_fast_retrans_estimate_segments_total", "kcp_fast_retrans_estimate_bytes_total", "kcp_rto_retrans_estimate_segments_total", "kcp_rto_retrans_estimate_bytes_total",
		"kcp_rtt_ms", "kcp_rto_ms", "kcp_rttvar_ms", "kcp_rtt_samples_total",
		"kcp_ack_segments_total", "kcp_ack_progress_segments_total", "kcp_inflight_segments", "kcp_send_blocked_seconds_total",
		...
		"kcp_output_queue_depth", "kcp_output_queue_capacity", "kcp_update_backpressure_total", "kcp_mutex_blocked_seconds_total",
		"flow_reorder_abort_total", "outer_rtp_payload_type",
		"worker_output_queue_delay_ms", "worker_output_queue_late_total", "worker_write_latency_ms",
