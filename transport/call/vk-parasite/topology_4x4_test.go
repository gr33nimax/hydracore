...
func TestWorkerTelemetrySnapshotGauges(t *testing.T) {
	...
	require.Equal(t, float64(8_000_000), snap15.metrics["lane_admission_bytes_per_second"])
	require.Equal(t, float64(7_500_000), snap15.metrics["lane_delivered_bytes_per_second"])
