...
func TestWireV7ResetHandshakeSurvivesThirtyPercentControlLoss(t *testing.T) {
	t.Parallel()
...
func TestWireV7FragmentsTCPBeforeKCPButKeepsUDPDatagramsWhole(t *testing.T) {
	t.Parallel()
...
func TestWireV7SessionNoProgressDeadlineIsBounded(t *testing.T) {
	t.Parallel()
